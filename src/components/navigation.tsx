  ...
  return (
    <motion.header
      className={cn(
        ...
        isScrolled
          ? "bg-background/80 backdrop-blur-lg border-b border-divine"
          : "bg-transparent"
      )}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      <nav className="container flex items-center justify-between h-20 px-4 mx-auto">
        <Link href="/" className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold heading-divine">Sculptify</span>
        </Link>
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent side="right" className="w-[300px] glass-divine">
